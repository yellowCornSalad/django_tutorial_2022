...
# SECRET_KEY = 'django-insecure-*46w+r*-%thbkvo92$rg6of!f#l#bp2gm8#dqxtlpjwi9zoi60'
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '3.34.126.63']
...
# STATICFILES_DIR = BASE_DIR, '', 'static' 모두 가능
